...
<body background="connectwork.png";>
	...
	<div class="container maind">
		<div class="container-fluid">
			<center>
				<h2 class="heading">CLICK THE BELOW LINKS TO GET<br>MANUALS, ASSIGNMENT & TUTORIALS</h2><br>
				<a href="tcs.php" class="btn btn-light buttons"><b>TCS</b></a><br><br><br>
				<a href="mp.php" class="btn btn-light buttons"><b>MP</b></a><br><br><br>
		...
		<div class="container-fluid paad">
			<p>CREATED BY:<br>SUCHIT JADHAV <br>VINAY MAHESHWARI</p>
		</div>
	</div>
</body>
</html>